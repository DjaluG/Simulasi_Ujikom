        ...
        <div className='row'>
            <div className="col-lg-8 mx-auto">
                ...
                <form onSubmit={handleSubmit} action="">
                    ...
                    <div className="form-group mb-3">
                        <label className='form-label' htmlFor="name">Jurusan</label>
                        <input type="text" onChange={handleChange} name="jurusan" className='form-control' />
                    </div>
                    <div className="form-group mb-3">
                        <label className='form-label' htmlFor="jk">jk</label>
                        <input type="text" onChange={handleChange} name="jk" className='form-control' />
                    </div>
                    <div className="form-group mb-3">
